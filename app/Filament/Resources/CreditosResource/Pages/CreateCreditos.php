    ...
    protected function mutateFormDataBeforeCreate(array $data): array
{
    ...
    $formaPago = TipoPago::find($data['forma_pago'])->nombre; // Obtener el nombre del tipo de pago

    // Calcular valor total con interés
    $valorTotal = $valorCredito * (1 + ($porcentaje / 100));
    $data['saldo_actual'] = $valorTotal;

    // Calcular número de cuotas basado en la forma de pago
